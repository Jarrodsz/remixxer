import {getUserByEmail, getUserById} from 'app/models/user/get-user';
...
import type {UserSession} from '~/core/services/auth/session.server';
...
import {createEmailUser, createSocialUser} from 'app/domains/core/user/create-user';
